...
export default function Dashboard() {
  ...
  const handleDelete = (part: PartWithDetails) => {
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-slate-900" data-testid="stat-total-parts">
                    {(stats as any)?.totalParts?.toLocaleString() || '0'}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-slate-900" data-testid="stat-total-value">
                    {(stats as any)?.totalValue ? formatCurrency((stats as any).totalValue) : '$0'}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-slate-900" data-testid="stat-suppliers">
                    {(stats as any)?.activeSuppliers || '0'}
                  </p>
                </div>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <div className="relative inline-flex">
                            <Bell className="w-5 h-5 text-amber-600 hover:text-amber-800 hover:scale-110 transition-all duration-200 cursor-pointer" />
                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-600" data-testid={`text-part-number-${part.id}`}>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <Button variant="outline" className="w-full justify-start button-hover-blue transition-colors" data-testid="button-export-data">
            ...
            <div className="p-6 border-t border-slate-200">
              <div className="flex items-center justify-between">
                <p className="text-sm text-slate-600" data-testid="text-pagination-info">
                  Showing 1 to {Math.min(5, recentParts?.length || 0)} of {recentParts?.length || 0} entries
                </p>
                <div className="flex items-center space-x-2">
