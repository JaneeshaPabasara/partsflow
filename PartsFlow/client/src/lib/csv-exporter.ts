...
export function exportToCSV(data: PartWithDetails[], filename: string) {
  const headers = [
    'Part Number',
    'Name', 
    'Description',
...
export function exportSupplierAnalysisCSV(data: any[], filename = 'supplier-analysis') {
...
export function exportStockMovementsCSV(movements: any[], filename = 'stock-movements') {
...
export function exportLowStockCSV(data: PartWithDetails[], filename = 'low-stock-report') {
